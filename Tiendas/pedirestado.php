...
$url = $_POST["txtURL"]; // url del servidor de tiendas
...
$time = $timestamp->item(0)->nodeValue;
	...
	$sql="INSERT INTO mensajes (idEmisor,idReceptor,timestamp,tipo) VALUES ('monitor','$url','$time','$tipomsn')"; 
